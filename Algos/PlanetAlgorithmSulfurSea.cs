...
namespace MorePlanetTypes.Algos {
    public class PlanetAlgorithmSulfurSea : PlanetAlgorithm1 {
		public override void GenerateTerrain(double modX, double modY) {
			...
			double num3 = 0.01;     //  0.01	//  0.01?		// ?
									// Kind of known
			double num5 = -2.0;     // -0.2		// -1.0?		// Amount of water on planet. -0.2 = ~55% land, -2.2 = ~9% land
			...
			double num9 = 0.5;      //  0.3		//  0.5?		// Land blob number? Land blobiness?
									// Known
			double numLandHeightFactor = 8.0;       //  3.0		//	5.0?		// Water depth and terrain height
